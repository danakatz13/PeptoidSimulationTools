...
do
  ...
  echo "-O -rem 0 -i equilibrate.mdin.$REP -o equilibrate.mdout.$REP -c min1.rst -r equilibrate.rst.$REP -x equilibrate.mdcrd.$REP -inf equilibrate.mdinfo.$REP -p design_1.parm7" >> equilibrate.groupfile
